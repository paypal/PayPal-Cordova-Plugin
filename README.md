...
Phonegap Build
--------------
If you using phonegap build just add `<gap:plugin name="com.paypal.cordova.mobilesdk" source="plugins.cordova.io" />` to your config.xml. If you want to specify version you can use also use phonegap service `<gap:plugin name="com.paypal.cordova.mobilesdk" version="3.1.8" />`For more details check http://docs.build.phonegap.com/en_US/configuring_plugins.md.html#Plugins
