...
/**
 * You use a getPayPalConfiguration object to configure many aspects of how the SDK behaves.
 ...
 *  }
 */
PayPalMobile.prototype.initializeWithClientIdsForEnvironments = function(clientIdsForEnvironments) {
  var failureCallback = function(error) {
    console.log(error);
  };

  cordova.exec(null, failureCallback, "PayPalMobile", "initializeWithClientIdsForEnvironments", [clientIdsForEnvironments]);
};
 ...
 */
PayPalMobile.prototype.preconnectWithEnvironment = function(environment) {
  var failureCallback = function(error) {
    console.log(error);
  };

  cordova.exec(null, failureCallback, "PayPalMobile", "preconnectWithEnvironment", [environment]);
};
 ...
 */
PayPalMobile.prototype.presentSinglePaymentUI = function(payment, paymentDetails, configuration, completionCallback, cancelCallback) {
  cordova.exec(completionCallback, cancelCallback, "PayPalMobile", "presentSinglePaymentUI", [payment, paymentDetails, configuration]);
};
